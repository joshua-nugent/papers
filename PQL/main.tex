...
Using 5000 simulated datasets for each combination of parameters, logistic-link GLMMs were fit via PQL, GHQ, and Laplace using SAS/STAT software version 15.1 (SAS Institute Inc., Cary, NC).
