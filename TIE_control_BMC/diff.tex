...
%DIF ADD tie_rates_LMM.tex     Mon Oct  5 12:47:35 2020
%%                                      %
...
\section*{\DIFdelbegin \DIFdel{Discussion}\DIFdelend \DIFaddbegin \DIFadd{Conclusions}\DIFaddend }
...
\section*{\DIFdelbegin \DIFdel{Competing interests}%DIFDELCMD < \MBLOCKRIGHTBRACE
%DIFDELCMD <   %%%
\DIFdel{The authors }\DIFdelend \DIFaddbegin \DIFadd{Declarations}}

\subsection*{\DIFadd{Ethics approval and consent to participate}}
\DIFadd{No ethics approvals or consent to participate were needed for this work.
}

\subsection*{\DIFadd{Consent for publication}}
\DIFadd{The authors consent to publication.
}

\subsection*{\DIFadd{Availability of data and material}}
\DIFadd{The datasets generated and analysed during the current study are available in the following repository: }\url{https://github.com/joshua-nugent/joshua-nugent.github.io/tree/master/missingtie}\DIFadd{.
}

\subsection*{\DIFadd{Competing interests}}
\DIFadd{The authors }\DIFaddend declare that they have no competing interests.

\DIFdelbegin \section*{\DIFdel{Author's contributions}}
%DIFAUXCMD
\DIFdelend \DIFaddbegin \subsection*{\DIFadd{Funding}}
\DIFadd{Support for this work for provided by NIH/NIGMS grant R01GM121370. The funders had no role in study design, data collection, analysis, interpretation of the data, decision to publish, or writing of the manuscript.
}
